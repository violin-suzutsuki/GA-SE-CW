    ...
    if(id.length == 0) {
        return (
            <div className='flex flex-col justify-center px-20 py-28 hero-bg'>
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">To get started use the dropdown menu below to select the report you would like to generate.</p>
